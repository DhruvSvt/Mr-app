<div class="side-content-wrap">
    ...
    <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        ...
        <ul class="childNav" data-parent="forms">
            ...
            <li class="nav-item">
                <a class="" href="forms/basic-action-bar.html">
                    <i class="nav-icon i-File-Clipboard-Text--Image"></i>
            ...
            <li class="nav-item">
                <a class="" href="forms/multi-column-forms.html">
                    <i class="nav-icon i-Split-Vertical"></i>
        ...
        <ul class="childNav" data-parent="widgets">
            ...
            <li class="nav-item">
                ...
                <a class="" href="widgets/app.html">
                    <i class="nav-icon i-Receipt-4"></i>
                    <span class="item-name">Widget App <span class="ml-2 badge badge-pill badge-danger">
                            New</span>
                    </span>
                </a>
            </li>
            <li class="nav-item">
                ...
                <a class="" href="widgets/weather-app.html">
                    <i class="nav-icon i-Receipt-4"></i>
                    <span class="item-name"> Weather App <span class="ml-2 badge badge-pill badge-danger">
                            New</span>
                    </span>
                </a>
            </li>
        ...
        <ul class="childNav" data-parent="charts">
            ...
            <li class="nav-item dropdown-sidemenu">
                ...
                <ul class="submenu">
                    ...
                    <li><a class="" href="charts/apexCandleStickCharts.html">CandleStick Charts</a></li>
        ...
        <ul class="childNav" data-parent="apps">
            ...
            <li class="nav-item dropdown-sidemenu">
                ...
                <ul class="submenu">
                    <li>
                        <a class="" href="apps/task-manager.html">
                            <i class="nav-icon i-Receipt"></i>
                            <span class="item-name">Task manager</span>
                        </a>
                    </li>
                    <li>
                        <a class="" href="apps/task-manager-list.html">
                            <i class="nav-icon i-Receipt-4"></i>
            ...
            <li class="nav-item dropdown-sidemenu">
                ...
                <ul class="submenu">
                    <li>
                        <a class="" href="apps/ecommerce/products.html">
                    ...
                    <li>
                        <a class="" href="apps/ecommerce/product-details.html">
                            <i class="nav-icon i-Tag-2"></i>
                            <span class="item-name">Product Details</span>
                        </a>
                    </li>
                    <li>
                        <a class="" href="apps/ecommerce/cart.html">
                    ...
                    <li>
                        <a class="" href="apps/ecommerce/checkout.html">
            ...
            <li class="nav-item dropdown-sidemenu">
                ...
                <ul class="submenu">
                    ...
                    <li>
                        <a class="" href="apps/contacts/contact-list-table.html">
                    ...
                    <li>
                        <a class="" href="apps/contacts/lists.html">
                            <i class="nav-icon i-Business-Mens"></i>
                            <span class="item-name">Contact Lists</span>
                        </a>
                    </li>
                    <li>
                        <a class="" href="apps/contacts/grid.html">
                            <i class="nav-icon i-Conference"></i>
                            <span class="item-name">Contact Grid</span>
                        </a>
                    </li>
                    <li>
                        <a class="" href="apps/contacts/contact-details.html">
        ...
        <ul class="childNav" data-parent="uikits">
            ...
            <li class="nav-item">
                <a class="" href="uikits/bootstrap-tab.html">
                    <i class="nav-icon i-Cursor-Click"></i>
