@extends('admin.layouts.app', ['title' => 'Edit ' . $chemist->name])
@section('section')
    <div class="main-content-wrap sidenav-open d-flex flex-column">
        <div class="main-content">
            <div class="breadcrumb col-12">
                <div class="col-6">
                    <h1><u>Edit {{ $chemist->name }} Profile <i class="nav-icon i-shop"></i></u></h1>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="{{ route('chemist.update', $chemist->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="email" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter email" name="email" value="{{ $chemist->email }}">
                                        @error('email')
                                            <p class="text-danger text-sm">{{ $message }}</p>
                                        @enderror
                                    </div>
                                        ...
                                        <select class="form-control" name="speciality_id">
                                            @foreach ($specialities as $speciality)
                                                <option value="{{ $speciality->id }}"
                                                    {{ $speciality->id == $chemist->speciality_id }} ? selected>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <select class="form-control" name="area_id">
                                            @foreach ($areas as $area)
                                                <option value="{{ $area->id }}" {{ $area->id == $chemist->area_id }} ?
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        @if ($chemist->image)
                                            <img class="my-2"
                                                src="{{ asset('storage/images/chemists/' . $chemist->image) }}"
                                            ...
                                            <div class="row customarea{{ $key }}">
                                                ...
                                                <div class="col-md-4 form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter title"
                                                        name="title[]" value="{{ $chemist->title[$key] }}">
                                                    @error('title[]')
                                                        <p class="text-danger text-sm">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="col-md-5 form-group mb-3">
                                                    ...
                                                    <input class="form-control" id="phone" placeholder="Enter phone"
                                                        name="phn_no[]" value="{{ $chemist->phn_no[$key] ?? '' }}">
                                                    @error('phn_no[]')
                                                        <p class="text-danger text-sm">{{ $message }}</p>
                                                    @enderror
                                                </div>
